...
# --------------------
rsync -av /project/sm61/leclairm/CCLM2_sandbox/EU-CORDEX_50km/cesm_input/ ./cesm_input/
rsync -av /project/sm61/leclairm/CCLM2_sandbox/EU-CORDEX_50km/cosmo_input/ ./cosmo_input/
